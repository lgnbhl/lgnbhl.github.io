...
Office](https://www.bfs.admin.ch/bfs/en/home/statistics/catalogue.html)
(BFS stands for *Bundesamt für Statistik* in German) APIs in a dynamic
...
using the
[`bfs_get_sse_metadata()`](https://felixluginbuhl.com/BFS/reference/bfs_get_sse_metadata.md)
function. First get the codelist of a BFS dataset:
...
This query can be used in the new
...
function in any language (“de”, “fr”, “it” or “en”):
...
allows you to download any dataset from the [BFS
catalog](https://www.bfs.admin.ch/bfs/en/home/statistics/catalogue.html)
...
When running the
[`bfs_get_data()`](https://felixluginbuhl.com/BFS/reference/bfs_get_data.md)
function you may get the following error message (issue
...
to read it locally or b) query only specific elements of the data to
reduce the API call (see next section).
...
search for specific tables using
...
![](https://raw.githubusercontent.com/lgnbhl/BFS/master/man/figures/leaflet_g1.png)
...
from the ThemaKart project using
[`bfs_get_base_maps()`](https://felixluginbuhl.com/BFS/reference/bfs_get_base_maps.md).
The list of available geometries in the [official
...
[`bfs_get_base_maps()`](https://felixluginbuhl.com/BFS/reference/bfs_get_base_maps.md)
can be change to access specific files:
...
![](https://raw.githubusercontent.com/lgnbhl/BFS/master/man/figures/base_maps_file.png)
...
The function
[`bfs_get_base_maps()`](https://felixluginbuhl.com/BFS/reference/bfs_get_base_maps.md)
eases file selection with arguments and returns an sf object by default.
...
![](https://raw.githubusercontent.com/lgnbhl/BFS/master/man/figures/base_maps.png)

Note that the geometries are available for different date of data
release. By default,
[`bfs_get_base_maps()`](https://felixluginbuhl.com/BFS/reference/bfs_get_base_maps.md)
tries to get the most recent date. You can specify the date using the
“date” argument.
...
![](https://raw.githubusercontent.com/lgnbhl/BFS/master/man/figures/mapview.png)
...
![](https://raw.githubusercontent.com/lgnbhl/BFS/master/man/figures/base_maps_ge.png)

## Main dependencies of the package

Under the hood, this package is using the
[pxweb](https://ropengov.github.io/pxweb/index.html) package to query
the Swiss Federal Statistical Office PXWEB API. PXWEB is an API
structure developed by Statistics Sweden and other national statistical
institutions (NSI) to disseminate public statistics in a structured way.
To query the Geo Admin STAC API, this package is using the
...
by adding the argument `clean_names = TRUE` in the
[`bfs_get_data()`](https://felixluginbuhl.com/BFS/reference/bfs_get_data.md)
function.
