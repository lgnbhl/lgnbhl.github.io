...
Get the list of the data available in the official DAM-API of the Swiss
Federal Statistical Office asset catalog.
...
- url_structure_json:
  ...
  A character column with the URL of the json structure of the BFS
  dataset
