...
Material UI components wired to Shiny’s `input` object via
`.shinyInput()` / `update*.shinyInput()` pairs.
...
Overlay components whose open/close state is managed client-side, bound
to an existing DOM element by id. No server logic required.
...
Raw MUI input components (use `*.shinyInput()` variants above for Shiny
wiring).
...
- [`reexports`](https://felixluginbuhl.com/muiMaterial/reference/reexports.md)
  [`JS`](https://felixluginbuhl.com/muiMaterial/reference/reexports.md)
  [`reactOutput`](https://felixluginbuhl.com/muiMaterial/reference/reexports.md)
  [`renderReact`](https://felixluginbuhl.com/muiMaterial/reference/reexports.md)
  [`setInput`](https://felixluginbuhl.com/muiMaterial/reference/reexports.md)
  [`triggerEvent`](https://felixluginbuhl.com/muiMaterial/reference/reexports.md)
