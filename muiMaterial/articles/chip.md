...
The Chip component allows users to enter information, make selections,
filter content, or trigger actions. Chips are compact and often used in
forms, filters, and selection interfaces.
...
Use the `color` prop to apply theme colors to chips. Available colors
are: “default”, “primary”, “secondary”, “error”, “warning”, “info”,
“success”.
...
Control the size of chips using the `size` prop. Use “medium” (default)
or “small”.
...
Enable multiline text in chips using the `sx` prop to set `height: auto`
...
Add interactivity to chips using `onClick` with JavaScript callbacks and
...
Add a delete icon to chips using `onDelete` callback. Handle deletion by
...
Combine both click and delete functionality with custom JavaScript
callbacks.
...
Chips are keyboard accessible by default. When a chip is deletable or
clickable, it becomes a button in the tab order. When focused: -
