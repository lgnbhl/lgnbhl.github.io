...
page](https://mui.com/material-ui/react-checkbox/).
...
unchecked. It either submits its value or doesn’t. Visually, there are
...
When indeterminate is set, the value of the checked prop only impacts
the form submitted values. It has no accessibility or UX implications.

### FormGroup

FormGroup is a helpful wrapper used to group selection control
components.
