...
Below an simple example to add a custom image in your table
(i.e. wrapping the value in an styled “img” HTML tag):
...
You can create an React function to color the values and cell background
following a logic:
...
You can also use [Google Material Icons](https://fonts.google.com/icons)
by loading the font stylesheet with `htmltools::tags$link()`:
...
Once again, just ask an LLM to create a React function according to your
needs.
