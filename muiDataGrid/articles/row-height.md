...
The Data Grid provides flexible options for controlling row height, from
static heights to dynamic sizing based on content.
...
Customize the height of the column header using the `columnHeaderHeight`
prop:
