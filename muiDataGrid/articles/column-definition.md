...
Column definitions in the Data Grid specify how data is displayed,
...
The text displayed in the column header. Defaults to the field name if
not specified.
...
types: - `"string"` (default) - `"number"` - `"date"` - `"dateTime"` -
...
Flexible column width as a proportion of available space. Cannot be used
with `width`.
